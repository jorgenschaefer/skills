...
Review skills are invoked with a feature slug argument (e.g., `/discovery-review payment-retry`). The slug is used to construct both the artifact path to read and the review output path.
